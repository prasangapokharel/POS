...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $db->prepare("INSERT INTO customers (customer_id, name, email, phone, address, city, state, zip_code, country) VALUES (:customer_id, :name, :email, :phone, :address, :city, :state, :zip_code, :country)");
...
<head>
    ...
    <title>Create Customer - Billing System</title>
...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <main class="flex-1">
            <h1 class="text-3xl font-bold text-gray-800 mb-6">Create New Customer</h1>
