...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2025 at 01:08 PM
...
(2, 'ADMA95F37', 'Prasanga Raman Pokharel', 'prasangaramanpokharel@gmail.com', '$2y$10$dcKXJjAMpFd2EClwfn2sJ.VbeN9ThKfEeR4/iOdDinpMlJlLFEAiy', 'active', '2025-08-04 10:26:50', '2025-08-04 10:27:02');
...
(2, 'CUST002', 'Jane Smith', 'jane@example.com', '555-0102', '456 Oak Ave', 'Los Angeles', 'CA', '90001', 'USA', 'active', 1800.00, 1800.00, 0.00, '2025-07-29 02:05:13', '2025-08-04 05:22:42'),
(3, 'CUST003', 'Mike Johnson', 'mike@example.com', '555-0103', '789 Pine St', 'Chicago', 'IL', '60601', 'USA', 'active', 3200.00, 2800.00, -1800.00, '2025-07-29 02:05:13', '2025-08-04 05:22:45'),
...
(5, 'CUST005', 'David Brown', 'david@example.com', '555-0105', '654 Maple Dr', 'Phoenix', 'AZ', '85001', 'USA', 'active', 4461.70, 2100.00, 0.00, '2025-07-29 02:05:13', '2025-08-04 11:05:27'),
(6, 'CUSTB167CD', 'Prasanga', 'prasangaramanpokharel@gmail.com', '9705470926', '', 'Inaruwa', '', '', 'USA', 'active', 2200.00, 0.00, 0.00, '2025-08-04 10:50:35', '2025-08-04 10:56:45');
...
(4, 'ITM004', 'Desk Lamp', 'LED desk lamp with adjustable brightness', 'Furniture', 'pcs', 29, 8, 1000, 1500.00, 2200.00, NULL, 'active', '2025-08-01 17:19:29', '2025-08-04 11:05:27'),
...
(2, 'TRN68903B2DAFD9E', 'ITM004', 'sale', 1, 1500.00, 2200.00, 'ORD68903B2DAAB3A', 'order', NULL, 'CUST005', NULL, '2025-08-04', 'System Administrator', '2025-08-04 04:46:37'),
(3, 'TRN68903C982238C', 'ITM004', 'sale', 1, 1500.00, 2200.00, 'ORD68903C981E7AF', 'order', NULL, 'CUST002', NULL, '2025-08-04', 'System Administrator', '2025-08-04 04:52:40'),
(4, 'TRN68903DBFDD9BB', 'ITM004', 'sale', 1, 1500.00, 2200.00, 'ORD68903DBFD87A2', 'order', NULL, 'CUST003', NULL, '2025-08-04', 'System Administrator', '2025-08-04 04:57:35'),
(5, 'TRN689041BD36EFC', 'ITM004', 'return', 1, 1500.00, 1500.00, 'ORD68903DBFD87A2', 'order_cancel', NULL, 'CUST003', NULL, '2025-08-04', 'System Administrator', '2025-08-04 05:14:37'),
(6, 'TRN689043A259360', 'ITM004', 'return', 1, 1500.00, 2200.00, 'ORD68903C981E7AF', 'order_return', NULL, 'CUST002', NULL, '2025-08-04', 'System Administrator', '2025-08-04 05:22:42'),
(7, 'TRN689043A5F2D56', 'ITM004', 'return', 1, 1500.00, 2200.00, 'ORD68903DBFD87A2', 'order_return', NULL, 'CUST003', NULL, '2025-08-04', 'System Administrator', '2025-08-04 05:22:45'),
(8, 'TRN689043A9077A4', 'ITM004', 'return', 1, 1500.00, 2200.00, 'ORD68903B2DAAB3A', 'order_return', NULL, 'CUST005', NULL, '2025-08-04', 'System Administrator', '2025-08-04 05:22:49'),
(9, 'TRN689085AFC5956', 'ITM004', 'return', 5, 1500.00, 11000.00, 'ORD688F9EFD8D94E', 'order_return', NULL, 'CUST005', NULL, '2025-08-04', 'System Administrator', '2025-08-04 10:04:31'),
(10, 'TRN6890907B22AD0', 'ITM004', 'sale', 1, 1500.00, 2200.00, 'ORD6890907B1CA9A', 'order', NULL, 'CUSTB167CD', NULL, '2025-08-04', 'System Administrator', '2025-08-04 10:50:35'),
(11, 'TRN689093F7A30E5', 'ITM004', 'sale', 1, 1500.00, 2200.00, 'ORD689093F7A20F8', 'order', NULL, 'CUST005', NULL, '2025-08-04', 'System Administrator', '2025-08-04 11:05:27');
...
CREATE TABLE `orders` (
  ...
  `discount_amount` decimal(10,2) DEFAULT 0.00 COMMENT 'Discount amount applied to the order',
  `grand_total` decimal(12,2) NOT NULL DEFAULT 0.00,
  `payment_method` enum('mobilebanking','esawa','cash','khalti') DEFAULT NULL,
...
INSERT INTO `orders` (`id`, `order_id`, `customer_id`, `order_date`, `total_amount`, `vat_amount`, `discount_amount`, `grand_total`, `payment_method`, `status`, `notes`, `created_at`, `updated_at`) VALUES
(5, 'ORD6890907B1CA9A', 'CUSTB167CD', '2025-08-04 10:50:35', 2200.00, 0.00, 0.00, 2200.00, 'cash', 'paid', '', '2025-08-04 10:50:35', '2025-08-04 10:56:30'),
(6, 'ORD689093F7A20F8', 'CUST005', '2025-08-04 11:05:27', 2200.00, 271.70, 110.00, 2361.70, 'cash', 'paid', '', '2025-08-04 11:05:27', '2025-08-04 11:05:27');
...
(6, 'ORD6890907B1CA9A', 'ITM004', 1, 2200.00, 2200.00, '2025-08-04 10:56:30'),
(7, 'ORD689093F7A20F8', 'ITM004', 1, 2200.00, 2200.00, '2025-08-04 11:05:27');
...
ALTER TABLE `khalti_payments`
  ...
  ADD KEY `fk_khalti_order` (`order_id`);
...
ALTER TABLE `orders`
  ...
  ADD KEY `customer_id` (`customer_id`),
  ADD KEY `idx_orders_discount_amount` (`discount_amount`);
...
--
ALTER TABLE `khalti_payments`
  ADD CONSTRAINT `fk_khalti_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE;
