...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Generate a simple unique supplier ID
    $supplier_id = 'SUP' . strtoupper(uniqid());

    try {
        $stmt = $db->prepare("INSERT INTO suppliers (supplier_id, name, company, email, phone, address, city, state, zip_code, country, contact_person, tax_id, payment_terms) VALUES (:supplier_id, :name, :company, :email, :phone, :address, :city, :state, :zip_code, :country, :contact_person, :tax_id, :payment_terms)");
...
<head>
    ...
    <title>Create Supplier - Billing System</title>
...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <main class="flex-1">
            <h1 class="text-3xl font-bold text-gray-800 mb-6">Create New Supplier</h1>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <form action="create-supplier.php" method="POST">
